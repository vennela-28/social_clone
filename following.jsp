...
<html>
<head>
    <title>Following - Social Media</title>
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .following { padding: 15px; border-bottom: 1px solid #efefef; }
        .following a { text-decoration: none; color: #262626; font-weight: bold; }
        .following a:hover { color: #0095f6; }
    </style>
</head>
<body>
    <div class="navbar">
    ...
    <div class="container">
        ...
        try{
            ...
            PreparedStatement ps = con.prepareStatement("SELECT u.id, u.username FROM follows f JOIN users u ON f.following_id=u.id WHERE f.follower_id=?");
            ps.setInt(1, uid);
        ...
        <%
            ...
            if(!found){
                out.println("<p>Not following anyone yet.</p>");
            }
            con.close();
        }catch(Exception e){
